...
require (
	...
	github.com/click33/sa-token-go/integrations/kratos v0.0.0
	github.com/click33/sa-token-go/storage/memory v0.0.0
...
require (
	...
	github.com/click33/sa-token-go/stputil v0.1.1 // indirect
