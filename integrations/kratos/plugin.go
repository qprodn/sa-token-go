...
// For 匹配指定operation（自动选择matcher类型）
func (e *Plugin) For(pattern string) *RuleBuilder {
	return &RuleBuilder{
		plugin:   e,
...
// ForExact 精确匹配
func (e *Plugin) ForExact(operation string) *RuleBuilder {
	return &RuleBuilder{
		plugin:   e,
...
// ForPrefix 前缀匹配
func (e *Plugin) ForPrefix(prefix string) *RuleBuilder {
	return &RuleBuilder{
		plugin:   e,
...
// ForSuffix 后缀匹配
func (e *Plugin) ForSuffix(suffix string) *RuleBuilder {
	return &RuleBuilder{
		plugin:   e,
...
// ForPattern 通配符匹配
func (e *Plugin) ForPattern(pattern string) *RuleBuilder {
	return &RuleBuilder{
		plugin:   e,
...
// ForRegex 正则匹配
func (e *Plugin) ForRegex(regex string) *RuleBuilder {
	return &RuleBuilder{
		plugin:   e,
...
// ForContains 包含匹配
func (e *Plugin) ForContains(substring string) *RuleBuilder {
	return &RuleBuilder{
		plugin:   e,
...
// ForFunc 自定义匹配函数
func (e *Plugin) ForFunc(fn func(operation string) bool, name ...string) *RuleBuilder {
	return &RuleBuilder{
		plugin:   e,
...
// ForMatcher 使用自定义matcher
func (e *Plugin) ForMatcher(matcher OperationMatcher, name ...string) *RuleBuilder {
	return &RuleBuilder{
		plugin:   e,
		matcher:  matcher,
		checkers: make([]Checker, 0),
...
// Skip 跳过指定operations
func (e *Plugin) Skip(patterns ...string) *Plugin {
	e.options.SkipOperations = append(e.options.SkipOperations, patterns...)
	return e
}
